...
in
{
  ...
  # Load blackout hosts file if it exists (generated by x-blackout-hosts script)
  networking.extraHosts =
    let
      blackoutHostsFile = "${inputs.private-nix}/sources/hosts/blackout-hosts";
    in
      if builtins.pathExists blackoutHostsFile
      then builtins.readFile blackoutHostsFile
      else "";
